...
int main()
{
	...
	for(i=0;i<5;i++)
	{
		if(scanf("%d %s %lf %lf %lf",&stu[i].id,stu[i].name,&stu[i].scores[0],&stu[i].scores[1],&stu[i].scores[2])!=5)
	    {
	       printf("输入错误\n");
	        return 1;}
	...
	if(scanf("%d %s %lf %lf %lf",&stu[5].id,stu[5].name,&stu[5].scores[0],&stu[5].scores[1],&stu[5].scores[2])!=5)
	{
		printf("输入错误\n");
		return 1;
	}
